...
#>  $ geometry  :'data.frame':  2 obs. of  3 variables:
#>   ..$ type       : chr  "MultiPolygon" "MultiPolygon"
#>   ..$ crs        :'data.frame':  2 obs. of  2 variables:
#>   .. ..$ type      : chr  "name" "name"
#>   .. ..$ properties:'data.frame':    2 obs. of  1 variable:
#>   .. .. ..$ name: chr  "urn:ogc:def:crs:EPSG::32630" "urn:ogc:def:crs:EPSG::32630"
#>   ..$ coordinates:List of 2
#>   .. ..$ : num [1, 1, 1:19, 1:2] 131119 193006 254993 316958 377405 ...
#>   .. ..$ : num [1, 1, 1:20, 1:2] 131185 193072 255059 317023 377470 ...
#>  $ properties:'data.frame':  2 obs. of  7 variables:
...
#>  $ geometry  :'data.frame':  11 obs. of  3 variables:
#>   ..$ type       : chr  "MultiPolygon" "MultiPolygon" "MultiPolygon" "MultiPolygon" ...
#>   ..$ crs        :'data.frame':  11 obs. of  2 variables:
#>   .. ..$ type      : chr  "name" "name" "name" "name" ...
#>   .. ..$ properties:'data.frame':    11 obs. of  1 variable:
#>   .. .. ..$ name: chr  "urn:ogc:def:crs:EPSG::32630" "urn:ogc:def:crs:EPSG::32630" "urn:ogc:def:crs:EPSG::32630" "urn:ogc:def:crs:EPSG::32630" ...
#>   ..$ coordinates:List of 11
#>   .. ..$ : num [1, 1, 1:5, 1:2] 141997 251731 249846 140108 141997 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 140268 250006 248301 138558 140268 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 199981 309779 309779 199981 199981 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 199981 309779 309779 199981 199981 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 199981 309779 309779 199981 199981 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 140268 250006 248301 138558 140268 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 140268 250006 248301 138558 140268 ...
...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 141997 251731 249846 140108 141997 ...
#>   .. ..$ : num [1, 1, 1:5, 1:2] 141997 251731 249846 140108 141997 ...
#>  $ properties:'data.frame':  11 obs. of  7 variables:
#>   ..$ id                  : chr  "S2A_OPER_MSI_L2A_TL_SHIT_20191122T060727_A008156_T29PRL_N00.01" "S2A_OPER_MSI_L2A_TL_SHIT_20191122T060743_A008156_T29PRK_N00.01" "S2A_OPER_MSI_L2A_TL_SHIT_20191122T060802_A008156_T30PTQ_N00.01" "S2A_OPER_MSI_L2A_TL_SHIT_20191122T060805_A008156_T30PTR_N00.01" ...
#>   ..$ date                : chr  "2017-01-13" "2017-01-13" "2017-01-13" "2017-01-13" ...
#>   ..$ time                : chr  "10:55:56" "10:55:56" "10:55:56" "10:55:56" ...
#>   ..$ path                : chr  "s3://sentinel-s2-l2a/tiles/29/P/RL/2017/1/13/0" "s3://sentinel-s2-l2a/tiles/29/P/RK/2017/1/13/0" "s3://sentinel-s2-l2a/tiles/30/P/TQ/2017/1/13/0" "s3://sentinel-s2-l2a/tiles/30/P/TR/2017/1/13/0" ...
#>   ..$ crs                 : chr  "EPSG:32629" "EPSG:32629" "EPSG:32630" "EPSG:32630" ...
#>   ..$ mbr                 : chr  "799980,990240 909780,1100040" "799980,890220 909780,1000020" "199980,890220 309780,1000020" "199980,990240 309780,1100040" ...
#>   ..$ cloudCoverPercentage: num  32 79 76.5 54.5 0 ...
#> NULL
...
#> Warning: Column `area_wkt` joining factor and character vector, coercing
#> into character vector
print(str(s1_urls))
#> 'data.frame':    8 obs. of  4 variables:
#>  $ name      : chr  "S1-AWS-IW-VVVH_20170130_VH__p1" "S1-AWS-IW-VVVH_20170130_VH__p2" "S1-AWS-IW-VVVH_20170130_VV__p1" "S1-AWS-IW-VVVH_20170130_VV__p2" ...
#>  $ time_start: chr  "2017-01-30" "2017-01-30" "2017-01-30" "2017-01-30" ...
#>  $ destfile  : chr  "S1-AWS-IW-VVVH/S1-AWS-IW-VVVH_20170130_VH__p1.tif" "S1-AWS-IW-VVVH/S1-AWS-IW-VVVH_20170130_VH__p2.tif" "S1-AWS-IW-VVVH/S1-AWS-IW-VVVH_20170130_VV__p1.tif" "S1-AWS-IW-VVVH/S1-AWS-IW-VVVH_20170130_VV__p2.tif" ...
...
#>  $ name      : chr  "S2L2A_20170113_9_SCENE_CLASSIFICATION__p1" "S2L2A_20170113_9_SCENE_CLASSIFICATION__p2" "S2L2A_20170113_B04__p1" "S2L2A_20170113_B04__p2" ...
#>  $ time_start: chr  "2017-01-13" "2017-01-13" "2017-01-13" "2017-01-13" ...
#>  $ destfile  : chr  "S2L2A/S2L2A_20170113_9_SCENE_CLASSIFICATION__p1.tif" "S2L2A/S2L2A_20170113_9_SCENE_CLASSIFICATION__p2.tif" "S2L2A/S2L2A_20170113_B04__p1.tif" "S2L2A/S2L2A_20170113_B04__p2.tif" ...
